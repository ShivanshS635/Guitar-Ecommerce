...
const Craftsmanship = () => (
  <section className="bg-zinc-900 py-16 px-6 text-white flex flex-col md:flex-row items-center">
    <div className="md:w-1/2 mb-8 md:mb-0">
      <img src={assets.workshop} alt="Workshop" className="rounded-lg shadow-lg" />
    </div>
